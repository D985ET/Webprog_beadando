...
<html>
    ...
    <?php
        ...
        <p><span class="error"><b>A *-gal jelölt mezők kitöltése kötelező</b></span></p>
        <form name="regurlap" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype=multipart/form-data>
        <table>
            ...
            <tr><td><input type="reset" value="Töröl" name="delete" class="button1"></td> <td><input type="submit" value="Elküld" name="send" class="button2"></td></tr>
        </table>
        </form>
        <table>
        <tr><td><a href="login.html"><input type="submit" value="Vissza"></a></td></tr>
        </table>
        </div>
        ...
        if(isset($_POST["send"]))
        {
            ...
            $beirando = "users/".$_POST["_username"] . "/".$filename;
           ...
           $result = mysqli_query($con,$query);
            ...
            else
            {
                ...
                echo "<b><a href=login.html>Vissza a bejelentkezéshez</a></b>";
                echo "</div>";
            }
            mysqli_close($con);
